...
# -------------------- [1 REQ] -------------------#
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://naturalhealthconnections.com.au/membership-account/membership-checkout/');
curl_setopt($curl, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_HTTPHEADER, array(
'authority: naturalhealthconnections.com.au',
'method: POST',
...
'origin: https://naturalhealthconnections.com.au',
'referer: https://naturalhealthconnections.com.au/membership-account/membership-checkout/',
...
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);level=1&checkjavascript=1&other_discount_code=&username=mohamed&password=zY2-npa-M6V-jct&password2=zY2-npa-M6V-jct&bemail=fhgftgnhh%40gmail.com&bconfirmemail=fhgftgnhh%40gmail.com&fullname=&CardType=visa&discount_code=&tos=1&submit-checkout=1&javascriptok=1&payment_method_id=pm_1M8g6rGEjYljGM3tS3HFyb8A&AccountNumber=XXXXXXXXXXXX8785&ExpirationMonth=05&ExpirationYear=2026
